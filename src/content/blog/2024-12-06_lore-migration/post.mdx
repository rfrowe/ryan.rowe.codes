...
This thing, with its 8-core Intel&reg; Xeon&reg; D-1541, is no joke especially with a nice helping of 128GiB ECC DDR4 memory.
...
However, once I stood up a Minecraft server for myself and my friends, the relatively low single-core clock speed (2.1GHz) combined with the 40mm fan form factor quickly led to, as my partner so lovingly described, an urgently untenable situation.
...
40mm ain't much to work with, so allowing 3U means larger fans and therefore more mass airflow per revolution of the blades.
...
What remained non-obvious was how to cram a full height graphics card into 3U.
Thankfully, Sliger came to my rescue with the Sliger CX3150a.
This beast boasts a 3U form factor with room for a full height GPU via PCIe riser.
