...
$$
\begin{align*}
\bullet\quad& \cos \pi x\\
\bullet\quad& \sin \pi y\\
\bullet\quad& \frac{x + z}{2}\\
\bullet\quad& zx
\end{align*}
$$
...
{/* Interactive cube deferred to Phase 5: cubeCard.tsx/cubeRenderer.tsx are still
    MUI/Gatsby-based and are ported (not rewritten) in that phase. */}
